...
export const ChainBalance = ({
  ...
  return (
    <div className="min-w-80 flex-1 rounded-xl border border-solid border-slate-100 bg-white p-4">
      ...
      <div className="mt-4 flex items-center justify-between rounded border border-solid border-slate-100 bg-neutral-50 p-2 text-sm text-neutral-600 break-all">
        <span>{address}</span>
